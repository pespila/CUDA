    ...
    \frame{
        ...
        \begin{figure}[!htb]
            ...
            \minipage{0.32\textwidth}
              ...
              \caption{Boyle-Dysktra\\Level: 16\\Memory Used: 1.33 GB\\Runtime: 4505 s}
            \endminipage\hfill
            \minipage{0.32\textwidth}%
              \includegraphics[width=\linewidth]{theme_cvpr/synthl.png}
              \caption{Lagrange-Multipliers\\Level: 16\\Memory Used: 0.155 GB\\Runtime: 10.39 s}
            \endminipage
        \end{figure}
    ...
    \frame{
        ...
        \begin{figure}[!htb]
            ...
            \minipage{0.32\textwidth}
              ...
              \caption{Boyle-Dysktra\\Level: 16\\Memory Used: 1.33 GB\\Runtime: 4495 s}
            \endminipage\hfill
            \minipage{0.32\textwidth}%
              \includegraphics[width=\linewidth]{theme_cvpr/synthgaussl.png}
              \caption{Lagrange-Multipliers\\Level: 16\\Memory Used: 0.155 GB\\Runtime: 10.47 s}
            \endminipage
        \end{figure}
    ...
    \frame{
        ...
        \begin{figure}[!htb]
            ...
            \minipage{0.32\textwidth}%
              ...
              \caption{Lagrange-Multipliers\\Level: 16\\Memory Used: 0.155 GB\\Runtime: 10.42 s}
            \endminipage
        \end{figure}
    ...
    \frame{
        ...
        \begin{figure}[!htb]
            ...
            \minipage{0.32\textwidth}
              ...
              \caption{Boyle-Dysktra\\Level: 16\\Memory Used: 1.33 GB\\Runtime: 4501 s}
            \endminipage\hfill
            \minipage{0.32\textwidth}%
              \includegraphics[width=\linewidth]{theme_cvpr/inpaintl.png}
              \caption{Lagrange-Multipliers\\Level: 16\\Memory Used: 0.155 GB\\Runtime: 10.49 s}
            \endminipage
        \end{figure}
